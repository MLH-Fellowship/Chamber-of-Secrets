            ...
            <>
                <div id="modal-container">
                    <div className="modal-background">
                        <div className="modal">
                            <h2>Deleting...</h2>
                            <img alt="Deleting Animation GIF" src={deletegif} style={{ borderRadius: "10px", width: "300px" }} />
                    ...
                    <div className="modal">
                        {loadingState ?
                            <>
                                ...
                                <img alt={is_download ? "Downloading Animation GIF" : "Uploading Animation GIF"} src={is_download ? downloadgif : uploadgif} style={{ borderRadius: "10px", width: "300px" }} />
                            </>
                            :
                            <>
